  ...
  void handlePaymentSuccessResponse(PaymentSuccessResponse response) {
    ...
    * */
    ...
    firebaseDatabase.child('Users').child(utils.getUserId()).update({
      ...
      Common.userModel.value.userWallet = amountController.value.text.toString();
      Common.wallet.value =
                        ...
                        onTap: double.parse(amount.value) < 1
                            ...
                            : () {
                                var options = {
                                  ...
                                  'prefill': {
                                    'contact':
                                        Common.userModel.value.phoneNumber ?? "",
                                    'email': Common.userModel.value.email ?? "",
                                  },
                                  'external': {
                                    'wallets': ['paytm']
                                  }
